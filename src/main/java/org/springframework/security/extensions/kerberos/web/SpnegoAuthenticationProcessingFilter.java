...
import com.github.zollie.jsec.krb5.GssContextHolder;
import com.github.zollie.jsec.web.HttpServletRequestHolder;
        ...
        try {
	        ...
	        if ((header != null) && header.startsWith("Negotiate ")) {
	            ...
	            try {
	                ...
	                logger.warn("Negotiate Header was: " + header, e);
	                SecurityContextHolder.clearContext();
	                if (failureHandler != null && (e instanceof  AuthenticationException)) {
 	       ...
 	       /* I added the Spring Keberos code to our repo because 
 	        * they were not maintaining and breaking it with Spring 1.2
 	        * due to a Codec move. But since it's here it provides a nice 
 	        * place to clear our GSSContext.
 	        * -KZ 
 	        */
 	        GssContextHolder.clear();
 	//        SecurityContextHolder.clearContext();
